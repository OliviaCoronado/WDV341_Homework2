...
<body>
    ...
    <section>
        ...
        <form id="newsletter-form" name="newsletter_form" method="post" action="form-handler.php">
            ...
            <p>
            <input type="radio" name="subType" id="subType" value="Normal"/>
            <label for="subType">Normal</label>

            <input type="radio" name="subType" id="subType" value="Expert"/>
            <label for="subType">Expert</label><br>
            </p>


            <p>Recieve special offers and latest updates?
            <input type="checkbox" name="updateCheck" id="updateCheck"  value="Yes">
            <label for="updateCheck"> Yes </label>
            <input type="checkbox" name="updateCheck" id="updateCheck"  value="No">
            <label for="updateCheck"> No </label><br>
            </p>
            ...
            <p><input type="text" name="honeyPot" id="honeyPot"> </p>
    </p>
